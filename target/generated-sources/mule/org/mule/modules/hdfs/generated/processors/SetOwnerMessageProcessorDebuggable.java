...
public class SetOwnerMessageProcessorDebuggable
    extends SetOwnerMessageProcessor
    implements DebugInfoProvider
{


    public SetOwnerMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("ownername", "Ownername", (java.lang.String.class), ownername, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("path", "Path", (java.lang.String.class), path, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("groupname", "Groupname", (java.lang.String.class), groupname, muleEvent));
