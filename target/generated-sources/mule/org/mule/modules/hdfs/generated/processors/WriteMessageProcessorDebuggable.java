...
public class WriteMessageProcessorDebuggable
    extends WriteMessageProcessor
    implements DebugInfoProvider
{


    public WriteMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("bufferSize", "Buffer size", (int.class), bufferSize, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("replication", "Replication", (int.class), replication, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("ownerUserName", "Owner user name", (java.lang.String.class), ownerUserName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("overwrite", "Overwrite", (boolean.class), overwrite, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("path", "Path", (java.lang.String.class), path, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("payload", "Payload", (java.io.InputStream.class), payload, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("blockSize", "Block size", (long.class), blockSize, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("permission", "Permission", (java.lang.String.class), permission, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("ownerGroupName", "Owner group name", (java.lang.String.class), ownerGroupName, muleEvent));
