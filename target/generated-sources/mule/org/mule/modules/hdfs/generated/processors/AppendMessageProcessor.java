    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public AppendMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedPath = ((String) evaluateAndTransform(getMuleContext(), event, AppendMessageProcessor.class.getDeclaredField("_pathType").getGenericType(), null, path));
            final Integer _transformedBufferSize = ((Integer) evaluateAndTransform(getMuleContext(), event, AppendMessageProcessor.class.getDeclaredField("_bufferSizeType").getGenericType(), null, bufferSize));
            final InputStream _transformedPayload = ((InputStream) evaluateAndTransform(getMuleContext(), event, AppendMessageProcessor.class.getDeclaredField("_payloadType").getGenericType(), null, payload));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((HDFSConnector) object).append(_transformedPath, _transformedBufferSize, _transformedPayload);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at HDFSConnector at append retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
