...
public class GetMetadataMessageProcessorDebuggable
    extends GetMetadataMessageProcessor
    implements DebugInfoProvider
{


    public GetMetadataMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("muleEvent", "Mule event", (org.mule.api.MuleEvent.class), muleEvent, muleEvent));
