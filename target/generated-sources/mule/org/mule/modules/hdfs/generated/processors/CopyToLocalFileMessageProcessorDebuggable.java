...
public class CopyToLocalFileMessageProcessorDebuggable
    extends CopyToLocalFileMessageProcessor
    implements DebugInfoProvider
{


    public CopyToLocalFileMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("deleteSource", "Delete source", (boolean.class), deleteSource, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("source", "Source", (java.lang.String.class), source, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("target", "Target", (java.lang.String.class), target, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("useRawLocalFileSystem", "Use raw local file system", (boolean.class), useRawLocalFileSystem, muleEvent));
