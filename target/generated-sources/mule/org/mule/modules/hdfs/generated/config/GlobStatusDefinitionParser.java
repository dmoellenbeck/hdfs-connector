...
import org.mule.modules.hdfs.generated.processors.GlobStatusMessageProcessor;
import org.mule.modules.hdfs.generated.processors.GlobStatusMessageProcessorDebuggable;
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            ...
            if (muleVersion.atLeastBase("3.8.0")) {
                beanDefinitionBuilder = beanDefinitionBuilder = BeanDefinitionBuilder.rootBeanDefinition(GlobStatusMessageProcessorDebuggable.class.getName());
            } else {
                beanDefinitionBuilder = beanDefinitionBuilder = BeanDefinitionBuilder.rootBeanDefinition(GlobStatusMessageProcessor.class.getName());
            }
