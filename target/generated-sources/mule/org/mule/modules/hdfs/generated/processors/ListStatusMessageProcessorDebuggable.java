...
public class ListStatusMessageProcessorDebuggable
    extends ListStatusMessageProcessor
    implements DebugInfoProvider
{


    public ListStatusMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("filter", "Filter", (java.lang.String.class), filter, muleEvent));
