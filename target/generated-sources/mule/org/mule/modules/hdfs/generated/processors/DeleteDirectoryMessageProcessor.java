...
/**
 * DeleteDirectoryMessageProcessor invokes the {@link org.mule.modules.hdfs.HDFSConnector#deleteDirectory(java.lang.String)} method in {@link HDFSConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2016-09-16T09:46:00-03:00", comments = "Build UNNAMED.2793.f49b6c7")
public class DeleteDirectoryMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DeleteDirectoryMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedPath = ((String) evaluateAndTransform(getMuleContext(), event, DeleteDirectoryMessageProcessor.class.getDeclaredField("_pathType").getGenericType(), null, path));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((HDFSConnector) object).deleteDirectory(_transformedPath);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at HDFSConnector at deleteDirectory retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
