...
public class GetMetadataTestCases extends BaseTest {
    ...
    @Test
    public void shouldContainAllMetadataInfo() throws Exception {
        Map<String, Object> pathMetadata = (Map<String, Object>)TestDataBuilder
                .getValue(flowRunner(Util.FlowNames.GET_METADATA_FLOW).withVariable("path", PARENT_DIRECTORY + NEW_DIRECTORY).run());
