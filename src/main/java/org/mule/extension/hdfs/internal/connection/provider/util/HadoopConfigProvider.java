 ...
 */
package org.mule.extension.hdfs.internal.connection.provider.util;
...
public class HadoopConfigProvider {
    ...
    public Configuration getKerberosAuthConfig(String nameNodeUri, String principal, List<String> configurationResources, Map<String, String> configurationEntries) {
        validateNameNodeUri(nameNodeUri);
