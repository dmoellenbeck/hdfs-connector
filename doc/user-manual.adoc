...
Exsting demos demontrate how to use connector for link:/common-operations[basic file system operations] and how to link:/poll-from-file[poll data from a file] at specific interval.
...
This and other basic file systen operations are demonstrated within link:/common-operations[this] demo.
