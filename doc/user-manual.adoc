...
If the Hadoop instance is not installed in the same network as your machine, you will need to put this configuration entry, in the advanced tab of HDFS configuration.

image::advanced-connection.png[]
